# Test 13: Remove 1 Control Plane (2 CP + 3 Workers)
# Note: This should trigger interactive confirmation due to etcd quorum
...
talos_worker_configuration = [
  ...
  { node_name = "pve2", vm_name = "talos-worker-02", vmid = 301, cpu_cores = 2, memory = 4096, disk_size = 40 },
  { node_name = "pve4", vm_name = "talos-worker-03", vmid = 302, cpu_cores = 2, memory = 4096, disk_size = 40 },
]