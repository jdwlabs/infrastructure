...
untagged and their node keys expire. Prefer a tagged auth key when repeating
this, or disable key expiry per node — an expired node key stops renewal and
the certificate lapses quietly afterwards.
